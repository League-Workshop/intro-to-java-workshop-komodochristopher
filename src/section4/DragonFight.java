...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			// or a kick
			String name = JOptionPane.showInputDialog("yell or kick");
			...
			if (name.equals("kick")) {
				...
				playerDamage = new Random().nextInt(1000);
			...
			// 14. Else if the dragon's health is less than or equal to 0
				...
				JOptionPane.showMessageDialog(null, "Dragon is dead");
